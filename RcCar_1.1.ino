...
void turnLeft() { digitalWrite(in1,LOW);  digitalWrite(in2,LOW);  digitalWrite(in3,LOW); digitalWrite(in4,HIGH);  }
...
void callbackFn( const sensor_msgs::Joy& joy_msg){
  ...
  int xAxis = (joy_msg.axes[0] +1)*512;
  int yAxis = (joy_msg.axes[1] +1)*512;
